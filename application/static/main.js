// document.writeln("<script src='http://danml.com/js/download.js'></script>");
document.writeln("<script src='../static/download.js?1906241132'></script>");

var input; // 사용자가 선택한 텍스트 파일 dom 객체
var output; // 텍스트 파일을 출력하는 dom 객체
...
function init()
{
    ...
    radioButtons = document.getElementsByName("analysis_type");
    submitButton = document.getElementById("submit");
    downloadButton = document.getElementById("download");

    wordPairParamUI = document.getElementById("word_pair_param_ui");
    posList1 = document.getElementById("pos_list1");
    posList2 = document.getElementById("pos_list2");

    ngramsParamUI = document.getElementById("ngrams_param_ui");
    ngramsNumTokens = document.getElementById("ngrams_num_tokens");
    ngramsFreqThreshold = document.getElementById("ngrams_freq_threshold");
...
function onRadioChange(target)
{
    ...
    case 1:
        currentRoute = "/NGrams";
        wordPairParamUI.style.display = "none";
        ngramsParamUI.style.display = "block";
        break;

    // WordPair
    case 2:
        currentRoute = "/WordPair";
        wordPairParamUI.style.display = "block";
        ngramsParamUI.style.display = "none";
        break;
